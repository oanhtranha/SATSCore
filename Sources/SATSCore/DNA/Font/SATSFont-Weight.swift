...
public extension SATSFont.Weight {
    ...
    static let satsFeeling = SATSFont.Weight(name: "SATS feeling", font: HindFont.semiBold)
    static let updock = SATSFont.Weight(name: "SATS updock", font: UpdockFont.regular)
